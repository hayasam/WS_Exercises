 ...
 * generated in the ws.helloworld package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://helloworld.ws/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://helloworld.ws/", "helloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ws.helloworld
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://helloworld.ws/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://helloworld.ws/", name = "helloWorldResponse")
